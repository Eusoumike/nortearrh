  ...
  return (
    <div className="space-y-4 p-6">
      ...
      <Card className="overflow-hidden">
        <div className="grid grid-cols-[60px_1fr_140px_120px_140px_120px_36px] items-center gap-3 border-b border-border bg-surface-muted px-4 py-2 text-[11px] font-medium uppercase tracking-wider text-muted-foreground">
          <div>#</div>
          ...
          <div className="divide-y divide-border">
            {filtered.map((t: any) => (
              <Link
                key={t.id}
                to={`/tickets/${t.id}`}
                className="grid grid-cols-[60px_1fr_140px_120px_140px_120px_36px] items-center gap-3 px-4 py-3 transition-colors hover:bg-surface-muted"
              >
